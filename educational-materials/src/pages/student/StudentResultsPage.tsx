...
import { fetchStudentSessions } from '../../api/sessionsApi'
...
export function StudentResultsPage() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      setError(null)
      try {
        const list = await fetchStudentSessions()
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold text-slate-900">Мои результаты</h1>
      <p className="mt-2 text-slate-600">
        Сессии тестирования и оценка усвоения M<sub>C</sub> после завершения.
      </p>
